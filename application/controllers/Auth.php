...
class Auth extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Login to Hims Portfolio';
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Registration to Hims Portfolio';
            $this->load->view('templates/auth_header', $data);
            ...
            Congratulation! Please check your email or spam email and activate your account!  </div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_crypto' => 'ssl',
            'smtp_user' => 'ibrohiimhims@gmail.com',
        ...
        $this->email->from('ibrohimshims@gmail.com', 'Ibrohiim Hims');
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger text-center" role="alert">Email is not rergisterd or activated</div>');
                redirect('auth/forgotpassword');
            }
        }
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Password has benn changed! Please login!</div>');
            redirect('auth');
        }
    }
