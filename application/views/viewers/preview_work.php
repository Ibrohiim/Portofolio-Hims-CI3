        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8 image-content">
                    <img class="img-responsive" src="<?= base_url('/assets/dashboard_admin/img/gallery/' . $previewwork->image) ?>">
                </div>
                <div class="col-md-4 sticky-parent">
                    <div id="sticky_item">
                        <div class="project-desc">
                            <h2><?= $previewwork->name; ?></h2>
                            <span><a href=""><?= $previewwork->type; ?></a></span>
                            <p><?= $previewwork->captions; ?></p>
                            <p class="icon" style="margin-bottom: 0.5rem;">
                                <span><i class="icon-eye"></i> <?= $previewwork->preview; ?></span>
                                <span><i class="icon-heart"></i> <?= $previewwork->likegallery; ?></span>
                            </p>
                            ...
                            <?php if($this->session->userdata('email') !== null): ?>
                                <?php if($ceklike == 0): ?>
                                <a href="<?= base_url('viewers/like/'.$previewwork->id)?>" class="btn" style="background-color: #666666;"><i class="fa fa-thumbs-up"></i></a>
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                <?php if($cekdislike == 0): ?>
                                <a href="<?= base_url('viewers/dislike/'.$previewwork->id)?>" class="btn" style="background-color: #666666;"><i class="fa fa-thumbs-down"></i></a>
                                <?php else: ?>
                            ...
                            <p><a href="<?= base_url('viewers/work')?>" class="btn btn-primary">See Another</a> or 
                            <a href="<?= base_url(); ?>viewers/downloadgallery/<?= $previewwork->id; ?>" class="btn-download">Download</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <?= $this->session->flashdata('message'); ?>
                        <?= form_open_multipart('viewers/commentgallery');?>
                            <input type="hidden" name="id" id="id" value="<?= $previewwork->id?>">
