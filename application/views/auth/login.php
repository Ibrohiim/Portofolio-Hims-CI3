        ...
        <div class="header-body text-center mb-5">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Please login if you already have an account. if you don't have an account, please register first.</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <form role="form" method="POST" action="<?= base_url('auth'); ?>">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <div class="input-group-prepend">
                      <span toggle="#password" class="toggle-password input-group-text"><i class="fa fa-fw fa-eye field-icon"></i></span>
                    </div>
                  </div>
