    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-xl-8 order-xl-1">
                <?= form_open_multipart('data/updatework'); ?>
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $wo->id ?>">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0"><strong>Edit Work</strong></h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="<?= $wo->name; ?>">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label class="form-control-label">Category</label>
                                        <select name="category" id="category" class="form-control">
                                            <option value="<?= $wo->category?>"><?php if($wo->category == 3){
                                                echo "Work";
                                            }else{
                                            }?></option>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label class="form-control-label">Type</label>
                                        <select name="type" id="type" class="form-control">
                                            <option value="<?= $wo->type?>"><?= $wo->type?></option>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <textarea id="ckeditor" name="captions" class="form-control"><?= $wo->captions?></textarea>
                            </div>
                        </div>
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?= base_url('assets/dashboard_admin/img/gallery/') . $wo->image; ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-12 text-right">
                                <a href="<?= base_url('data/detailwork/' . $wo->id) ?>" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Detail</a>
