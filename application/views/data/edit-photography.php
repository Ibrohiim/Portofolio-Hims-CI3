<div class="header pb-6 d-flex align-items-center" style="min-height: 200px; background-image: url(<?= base_url('assets/dashboard_admin/'); ?>img/theme/Hims.jpeg); background-size: cover; background-position: center top;">
    <span class="mask bg-gradient-dark opacity-7"></span>
        <!-- Header container -->
        <?php foreach ($editphotography as $epg) { ?>
        <div class="container-fluid d-flex align-items-center">
            <div class="col-lg-6 col-7 p-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark m-0">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin');?>"><i class="fas fa-home"></i></a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('data/dataphotography');?>">photography Management</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Photography</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col-xl-8 order-xl-1">
                <?= form_open_multipart('data/updatephotography'); ?>
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $epg->id ?>">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0"><strong>Edit Photography</strong></h3>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="<?= $epg->name; ?>">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label class="form-control-label">Category</label>
                                        <select name="category" id="category" class="form-control">
                                            <option value="<?= $epg->category?>"><?php if($epg->category == 2){
                                                echo "Photography";
                                            }else{
                                            }?></option>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label class="form-control-label">Type</label>
                                        <select name="type" id="type" class="form-control">
                                            <option value="<?= $epg->type?>"><?= $epg->type?></option>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <textarea id="ckeditor" name="captions" class="form-control"><?= $epg->captions?></textarea>
                            </div>
                        </div>
                        <div class="pl-lg-4">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?= base_url('assets/dashboard_admin/img/gallery/') . $epg->image; ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-9">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 col-12 text-right">
                                <a href="<?= base_url('data/detailphotography/' . $epg->id) ?>" class="btn btn-primary btn-sm" role="button" aria-pressed="true">Detail</a>
