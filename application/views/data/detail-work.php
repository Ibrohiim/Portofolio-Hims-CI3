            ...
            <div class="col-lg-6 col-7 p-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark m-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Detail Work</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?= base_url('data/editwork/' . $detailwork->id) ?>" class="btn btn-sm btn-primary">Edit Work</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <form>
                            ...
                            <div class="pl-lg-4">
                                <div class="row justify-content-center">
                                    <div class="card align-items-center">
                                        <img style="width: 50%;height:auto;" src="<?= base_url('assets/dashboard_admin/img/gallery/') . $detailwork->image; ?>">
                                    </div>
                                </div>
                            </div>
                            <hr class="my-4" />
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control"><?= $detailwork->name;?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control"><?= $detailwork->type;?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control"><?php $date = date_create($detailwork->date);  
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <textarea id="ckeditor" class="form-control" readonly><?= $detailwork->captions?></textarea>
                                </div>
                            </div>
                        </form>
                    </div>
